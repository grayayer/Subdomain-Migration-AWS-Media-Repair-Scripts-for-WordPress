### **Archive Repair Toolkit: Readme & Scripts**

This toolkit was designed to fix broken media paths during WordPress subdomain migrations for the Portland Winter Light festival, specifically when using **WP Offload Media** with **Object Versioning** enabled. Feel free to adapt for your own purposes. 
...
* **Backend Editor:** Open a page like the [Glow Bar](https://2026.pdxwlf.com/wp-admin/post.php?post=11969&action=edit); images that were broken icons should now render perfectly.  
* **Page Source:** Inspect an image on the frontend. The src should point to https://pdxwlf.s3.us-west-2.amazonaws.com/... and include a versioning subfolder.